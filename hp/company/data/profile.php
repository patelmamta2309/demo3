...
if (isset($_POST['userSubmitButton'])) {
    ...
    $oldData['company_name'] = $_POST['company_name'];
    $oldData['company_description'] = $_POST['company_description'];
    ...
    $oldData['coordinator_name'] = $_POST['coordinator_name'];
    $oldData['coordinator_phone'] = $_POST['coordinator_phone'];
    $oldData['coordinator_email'] = $_POST['coordinator_email'];

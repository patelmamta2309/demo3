...
<head>
    ...
    <title><?php session_start(); echo $_SESSION['type']?> - company profile</title>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <!-- Start app main Content -->
                ...
                <div class="main-content">
                        <form method="POST" enctype="multipart/form-data" name="userform" id="userform"
                action="data/profile.php<?php echo $queryString; ?>" class="needs-validation" novalidate="">
                    ...
                    <section class="section">
                        <div class="section-header">
                            ...
                            <div class="section-header-breadcrumb">
                                <div class="breadcrumb-item active"><a href="/hp/manage_company/Dashboard.php">Dashboard</a></div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">User
                                                    Name</label>
                                                <div class="col-sm-12 col-md-7">
                                            ...
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Co-ordinator
                                                    Name</label>
                                                <div class="col-sm-12 col-md-7">

...
<head>
    ...
    <title><?php session_start(); echo $_SESSION['type']?> - job_request form</title>
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">job Request</div>
                        </div>
                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="hired_status" name="status" class="custom-control-input" value="1">
                                                    <label class="custom-control-label" for="hired_status">Hired</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="rejected_status" name="status" class="custom-control-input" value="0">
                                                    <label class="custom-control-label" for="rejected_status">Rejected</label>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">reason</label>
                                                 <div class="col-sm-12 col-md-7">
                                                    <textarea name="reason" id="reason" class="form-control" row="3" placeholder="enter reason hear..."></textarea>
                                                  <div class="invalid-feedback">

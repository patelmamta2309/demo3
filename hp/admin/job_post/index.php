                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">all job post</div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped v_center" id="jobTable">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Job_Title</th>
                                                        <th>Minimum_Percentage</th>
                                                        <th>Backlog</th>
                                                        <th>Job_Post_Date</th>
                                                        <th>Delete</th>
                                                        <th>Edit</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $row["minimum_percentage"]; ?>
                                                            </td>
                                                            <td>

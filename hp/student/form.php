...
<head>
    ...
    <title><?php session_start(); echo $_SESSION['type']?> - form</title>
...
<body class="layout-4">
    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <form name="userform" id="userform" enctype="multipart/form-data" action="data/submit.php<?php echo $queryString; ?>" method="post"
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <div id="image-preview" class="image-preview">
                                                        ...
                                                        <input type="file" name="studentProfile" id="image-upload" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="date" name="dob" id="dob" class="form-control"
                                                        ...
                                                        value="<?php echo isset($record) ? $record['dob'] : '' ?>"
                                                        required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="phone" id="phone" class="form-control"
                                                        placeholder="primary" placeholder="Enter your phone number"
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="alternative_number" id="alternative_number"
                                                        class="form-control" placeholder="Enter your alternate number"
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="genderMale" name="gender"
                                                        class="custom-control-input" placeholder="Enter your gender"
                                                        value="Male" <?php echo isset($record) ? ($record['gender'] === 'Male' ? 'checked' : '') : '' ?>>
                                                    <label class="custom-control-label" for="genderMale">Male</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="genderFemale" name="gender"
                                                        class="custom-control-input" placeholder="Enter your gender"
                                                        value="Female" <?php echo isset($record) ? ($record['gender'] === 'Female' ? 'checked' : '') : '' ?>>
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="address1" class="form-control mb-2"
                                                        placeholder="Street address"  value="<?php echo isset($record) ? $record['address1'] : '' ?>">
                                                    <div class="form-row">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="address2" class="form-control mb-2"
                                                        placeholder="Street address"  value="<?php echo isset($record) ? $record['address2'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">SGPA</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="sgpa" id="sgpa" class="form-control"
                                                        placeholder="primary"
                                                        value="<?php echo isset($record) ? $record['sgpa'] : '' ?>"
                                                        required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Backlog</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="backlogYes" name="backlog" value="1"
                                                            class="custom-control-input" <?php echo isset($record) ? ($record['backlog'] ? 'checked' : '') : '' ?> required>
                                                        <label class="custom-control-label" for="backlogYes">Yes</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="backlogNo" name="backlog" value="0"
                                                            class="custom-control-input" <?php echo isset($record) ? ($record['backlog'] ? "" : 'checked') : '' ?> required>
                                            ...
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Enrollment
                                                    number</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="enrollement_number" id="enrollement_number"
                                                        class="form-control" placeholder="Enter your enrollment number"
                                                        value="<?php echo isset($record) ? $record['enrollement_number'] : '' ?>"
                                                        required>
                                                    <div class="invalid-feedback">

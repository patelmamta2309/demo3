...
<head>
    ...
    <title><?php session_start(); echo $_SESSION['type']?> - faculty form</title>
                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        <form method="POST" id="userform" name="userform"
                            action="data/submit.php<?php echo $queryString; ?>" class="needs-validation" novalidate="">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <button type="submit" class="btn btn-primary"
                                                        name="userSubmitButton" href="index.php">Submit</button>
